...
namespace N2.Core.WorkFlow
{
    public static class WorkFlowManager
    {
        ...
        private static void SendMail(Sys_WorkFlowTable workFlow, FilterOptions filterOptions, Sys_WorkFlowTableStep nextStep, N2Context dbContext)
        {
